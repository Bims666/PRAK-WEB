    ...
    <div class="container mt-2">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="motor" id="support_motor" name="support"
                        <?php if(isset($barang['support']) && $barang['support'] == 'motor') echo 'checked'; ?>>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="mobil" id="support_mobil" name="support"
                        <?php if(isset($barang['support']) && $barang['support'] == 'mobil') echo 'checked'; ?>>
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="kondisi" id="kondisi_baru" value="baik"
                        <?php if($barang['kondisi']=='baru') echo 'checked'?>>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="kondisi" id="kondisi_bekas" value="rusak"
                        <?php if($barang['kondisi']=='bekas') echo 'checked'?>>
